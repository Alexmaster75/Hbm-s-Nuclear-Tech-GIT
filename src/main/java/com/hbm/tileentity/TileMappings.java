...
public class TileMappings {
	...
	public static void writeMappings() {
		...
		put(TileEntityMachineSatGroundRemote.class, "tileentity_satremote");
		...
		put(TileEntityCorePulse.class, "tileentity_v0_pulse");
	...
	private static void putMachines() {
		...
		put(TileEntityMoxer.class, "tileentity_moxer");
		put(TileEntityMachineTurboCompressor.class, "tileentity_turbocompressor");
