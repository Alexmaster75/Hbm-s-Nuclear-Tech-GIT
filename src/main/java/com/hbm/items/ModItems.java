...
public class ModItems {
	...
	public static Item ingot_catsmileium;
	...
	public static void initializeItem() {
		...
		ingot_catsmileium = new Item().setUnlocalizedName("ingot_catsmileium").setCreativeTab(MainRegistry.partsTab).setTextureName(RefStrings.MODID + ":ingot_catsmileium");
	...
	private static void registerItem() {
		...
		GameRegistry.registerItem(ingot_catsmileium, ingot_catsmileium.getUnlocalizedName());
