...
public class BufferUtil {
	...
	/**
	 * Writes a double array to a buffer.
	 */
	public static void writeDoubleArray(ByteBuf buf, double[] array) {
		buf.writeDouble(array.length);
	...
	/**
	 * Reads a double array from a buffer.
	 */
	public static double[] readDoubleArray(ByteBuf buf) {
		int length = (int) buf.readDouble();
